...
The F-test value for degrees of freedom (2, 59) is 10.137; with the F-statistic of 9.025 and a $p-value$ of `r tidy.score.hotel$p.value[1]`, we can reject $H_0$ and conclude that the mean scores between the sexes is not equal.
...
With a $p-value$ of `r tidy.sports.wilks$p.value[1]`, we can safely reject $H_0$ and conclude that the mean vectors aross the sports not equal.
